...
<body>
            ...
            <ul>
                ...
                <li class="dropdown-container">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="dropdown-container">
                            <a href="{{ route('student.students-tag') }}">Filipino</a>
                        </li>
                    </ul>
                </li>
    ...
    <main class="container mt-4">
        <div class="row">
            <div class="col-md-12">
                <h1 class="text-center mb-4">About ReadEase</h1>
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Our Mission</h5>
                        <p class="card-text">
                            ReadEase is dedicated to improving reading comprehension and assessment in both English and Filipino languages. 
                            Our platform provides a comprehensive solution for teachers and students to track and improve reading skills.
                        </p>
                        
                        <h5 class="card-title mt-4">What We Offer</h5>
                        <ul>
                            <li>Comprehensive reading assessments in English and Filipino</li>
                            <li>Detailed progress tracking and analytics</li>
                            <li>Personalized learning recommendations</li>
                            <li>Easy-to-use interface for both teachers and students</li>
                        </ul>
                        ...
                        <p class="card-text">
                            ...
                            We aim to support this vision by providing accessible and effective reading assessment tools.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <div class="footerA row m-0 mt-5">
        <div class="col-md-4">
            <h2>VISION</h2>
