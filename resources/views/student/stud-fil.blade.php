...
@section('content')
                    ...
                    <div class="assessment-warning-card">
                        ...
                        <div class="warning-content">
                            <div class="warning-header">
                                <h3>Kinakailangan ang Reading Assessment</h3>
                                <span class="warning-badge">Kailangan Gawin</span>
                            </div>
                            <div class="warning-message">
                                <p>Bago ka magsagot sa pagsusulit na ito, kailangan mo munang makumpletuhin ang reading assessment kasama ng inyong guro.</p>
                            </div>
                            <div class="warning-steps">
                                <h4>Mga Susunod na Hakbang:</h4>
                                <div class="steps-list">
                                    <div class="step-item">
                                        <span class="step-number">1</span>
                                        <span class="step-text">Makipag-ugnayan sa inyong guro para sa reading assessment</span>
                                    </div>
                                    <div class="step-item">
                                        <span class="step-number">2</span>
                                        <span class="step-text">Kumpletuhin ang reading assessment session</span>
                                    </div>
                                    <div class="step-item">
                                        <span class="step-number">3</span>
                                        <span class="step-text">Bumalik dito para sa comprehension test</span>
                                    </div>
                                </div>
                            </div>
                            <div class="warning-note">
                                <i class="fas fa-info-circle"></i>
                                <span>Ang reading assessment ay tumutulong sa inyong guro na maintindihan ang inyong antas ng pagbabasa at magbigay ng personal na gabay.</span>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div id="assessmentRequiredModal" class="modal">
        <div class="confirmation-content assessment-required-modal">
            ...
            <h2>Kinakailangan ang Reading Assessment</h2>
            <p>Kailangan mong makumpletuhin ang reading assessment kasama ng inyong guro bago magsagot sa pagsusulit na ito.</p>
            <div class="modal-steps">
                <div class="modal-step">
                    <span class="step-icon">1</span>
                    <span>Makipag-ugnayan sa inyong guro</span>
                </div>
                <div class="modal-step">
                    <span class="step-icon">2</span>
                    <span>Kumpletuhin ang reading assessment</span>
                </div>
                <div class="modal-step">
                    <span class="step-icon">3</span>
                    <span>Bumalik para sa pagsusulit</span>
                </div>
            </div>
            <div class="confirmation-buttons">
                <button class="confirm-submit" onclick="closeAssessmentRequiredModal()">Naiintindihan Ko</button>
            </div>
        </div>
    </div>
