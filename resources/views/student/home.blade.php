...
<head>
    ...
    <title>ReadEase - Student Home</title>
</head>
<body>
    ...
    <main class="container mt-4">
        <div class="row">
            <div class="col-md-12">
                <h1 class="text-center mb-4">Welcome to ReadEase</h1>
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Student Dashboard</h5>
                        <p class="card-text">Welcome to your reading assessment platform. Here you can:</p>
                        <ul>
                            <li>Take reading assessments in English</li>
                            <li>Take reading assessments in Filipino</li>
                            <li>View your assessment results</li>
                            <li>Track your reading progress</li>
                        </ul>
                        <div class="text-center mt-4">
                            <a href="{{ route('student.students-eng') }}" class="btn btn-primary me-2">Start English Assessment</a>
                            <a href="{{ route('student.students-tag') }}" class="btn btn-primary">Start Filipino Assessment</a>
                        </div>
                    </div>
                </div>
            </div>
