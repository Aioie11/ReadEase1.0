...
<section class="hero">
    ...
    <a href="{{ route('teacher.viewreports') }}" class="btn btn-success rounded-pill ms-2">
        ...
        <div class="student-list">
            <h3>Grade 7 Students : SECTION Dao</h3>
    ...
    function submitReadingData(name) {
        if (readingData[name]) {
            ...
            .then(data => {
                ...
                window.location.href = '/teacher/viewreports?section=dao&language=Filipino';
            })
            .catch((error) => {
    ...
    function searchStudent() {
        ...
        .then(students => {
            if (students && students.length > 0) {
                ...
                studentContainer.innerHTML = '<p class="text-warning">No students found in Dao section with that name</p>';
            }
        })
        .catch(error => {
            console.error('Error:', error);
