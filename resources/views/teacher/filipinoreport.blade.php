...
@section('content')
    ...
    <div class="main-content">
        <div class="dashboard-wrapper">
            ...
            <div class="dashboard-grid">
                ...
                <!-- Right Column - Performance Metrics and Reading Guide -->
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const readingLevels = {
                1: { name: 'Frustration', wordReading: '89% below', comprehension: '58% below', description: 'Students struggle with reading material' },
                2: { name: 'Instructional', wordReading: '90-96%', comprehension: '59-79%', description: 'Students can read with teacher support' },
                3: { name: 'Independent', wordReading: '97-100%', comprehension: '80-100%', description: 'Students read fluently without assistance' }
            };
