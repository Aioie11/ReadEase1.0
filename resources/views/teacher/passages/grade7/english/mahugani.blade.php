    ...
    <div class="container">
        ...
        <div class="passage-container">
            ...
            <div id="passage-text" class="passage-text">
                Michael was a young boy who loved playing basketball. Every afternoon after school, he would practice shooting hoops in his backyard. His father had installed a basketball ring on their garage wall, and Michael spent hours perfecting his shots. He joined the school basketball team and became one of their best players. His coach taught him the importance of teamwork and discipline. Michael's dream was to play in the national basketball league one day. He knew that with hard work and dedication, he could achieve his goal. His parents were very supportive and always cheered for him during his games.
            </div>
        </div>
    ...
    <script>
        ...
        function setPassage(language) {
            ...
            if (language === 'english') {
                ...
                text.textContent = 'Michael was a young boy who loved playing basketball. Every afternoon after school, he would practice shooting hoops in his backyard. His father had installed a basketball ring on their garage wall, and Michael spent hours perfecting his shots. He joined the school basketball team and became one of their best players. His coach taught him the importance of teamwork and discipline. Michael\'s dream was to play in the national basketball league one day. He knew that with hard work and dedication, he could achieve his goal. His parents were very supportive and always cheered for him during his games.';
                englishBtn.classList.add('active');
                filipinoBtn.classList.remove('active');
            } else {
                title.textContent = 'TALATA SA PAGBASA';
                text.textContent = 'Si Michael ay isang batang lalaki na mahilig maglaro ng basketball. Tuwing hapon pagkatapos ng klase, nagsasanay siya ng pag-shoot sa kanilang bakuran. Nag-install ang kanyang ama ng basketball ring sa dingding ng kanilang garahe, at ginugugol ni Michael ang maraming oras sa pagpapaganda ng kanyang mga tira. Sumali siya sa basketball team ng paaralan at naging isa sa kanilang pinakamahusay na manlalaro. Tinuruan siya ng kanyang coach ng kahalagahan ng pagtutulungan at disiplina. Ang pangarap ni Michael ay makapaglaro sa pambansang basketball league balang araw. Alam niya na sa pamamagitan ng sipag at dedikasyon, makakamit niya ang kanyang layunin. Ang kanyang mga magulang ay napaka-suportado at palaging sumisigaw para sa kanya sa panahon ng kanyang mga laro.';
