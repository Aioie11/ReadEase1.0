    ...
    <div class="dashboard-wrapper">
        ...
        <div class="dashboard-grid">
            ...
            <div class="dashboard-column main-column">
                ...
                <div class="chart-panel">
                    <div class="chart-panel-header">
                        <h3 id="englishComprehensionChartTitle">🧠 Comprehension Level Distribution - Grade {{ (string)($grade ?? '7') }} (All Sections)</h3>
                        <div class="time-selector">
                            <button class="time-btn active">Selected Grade</button>
                        </div>
                    </div>
                ...
                <div class="performance-metrics">
                    ...
                    <div class="performance-card">
                        ...
                        <div class="performance-content">
                            ...
                            <div class="performance-stats">
                                <span class="student-count" id="readingStudentCount">{{ $total_students ?? 0 }} students</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="performance-card">
                        ...
                        <div class="performance-content">
                            ...
                            <div class="performance-stats">
                                <span class="student-count" id="comprehensionStudentCount">{{ $total_students ?? 0 }} students</span>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function updateUIWithData(data, grade, section) {
            ...
            window.mainChart.data.datasets[0].data = newChartData;
            window.mainChart.data.datasets[0].backgroundColor = ['#00B8A9', '#F6AD55', '#E53E3E'];

            window.mainChart.update('active');

            console.log('Updated main chart with data:', newChartData);

            // Update performance cards with new data
            updatePerformanceCards(
                data.reading_level_distribution,
                data.comprehension_level_distribution || data.reading_level_distribution
            );
        ...
        function updateEnglishComprehensionChart(data, grade, section) {
            ...
            // Update chart title
            const chartTitle = section === 'all'
                ? `🧠 Comprehension Level Distribution - Grade ${grade} (All Sections)`
                : `🧠 Comprehension Level Distribution - Grade ${grade} - ${section.charAt(0).toUpperCase() + section.slice(1)}`;
            ...
            // Update chart data (always keep colors)
            window.englishComprehensionChart.data.datasets[0].data = newComprehensionData;
            window.englishComprehensionChart.data.datasets[0].backgroundColor = ['#00B8A9', '#F6AD55', '#E53E3E'];

            window.englishComprehensionChart.update('active');

            console.log('Updated comprehension chart with data:', newComprehensionData);

            // Update performance cards when comprehension data changes
            const currentReadingData = window.mainChart ? {
                Independent: window.mainChart.data.datasets[0].data[0] || 0,
                Instructional: window.mainChart.data.datasets[0].data[1] || 0,
                Frustration: window.mainChart.data.datasets[0].data[2] || 0
            } : { Independent: 0, Instructional: 0, Frustration: 0 };

            updatePerformanceCards(currentReadingData, gradeData);
        }
    });
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        console.log('Page loaded - fetching initial data for grade:', currentGrade, 'section:', currentSection);
